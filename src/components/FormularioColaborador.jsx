...
const FormularioColaborador = () => {
  ...
  return (
    <form className='bg-white py-10 px-5 w-full md:w-1/2 rounded-lg shadow' onSubmit={handleSubmit}>
        ...
        <input type="submit" className='bg-sky-600 hover:bg-sky-700 w-full p-3 text-white uppercase font-bold cursor-pointer transition-colors rounded text-sm text-center' value='Buscar Colaborador'/>
